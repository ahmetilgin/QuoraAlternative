             ...
             <div onclick="location.href='PostController?action=up&AMP;postId=${post.id}'" class="arrow" style="cursor: pointer;"></div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ${post.content}<br><br>
                        <p class="card-subtitle mb-2 text-muted"><small style="font-size:85%;"><strong>Oluşuturulma Tarihi ${post.created_date} &nbsp;--&nbsp; Düzenlenme Tarihi ${post.modified_date} &nbsp;by&nbsp; ${post.user.user_name}</strong></small></p>
