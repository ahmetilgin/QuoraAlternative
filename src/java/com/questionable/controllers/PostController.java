...
public class PostController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            ...
            try {
                String postId = request.getParameter("postId");
                PostDB.upLikeCountPost(Integer.parseInt(postId));
                ArrayList<Post> posts = PostDB.getPostsByStatus("valid");
                request.setAttribute("posts", posts);
                url = "/home.jsp";
            ...
            try {
                String postId = request.getParameter("postId");
                PostDB.downLikeCountPost(Integer.parseInt(postId));
                ArrayList<Post> posts = PostDB.getPostsByStatus("valid");
                request.setAttribute("posts", posts);
                url = "/home.jsp";
            } // forward request and response objects to specified URL
            ...
            try {
                PostDB.deleteComment(Integer.parseInt(commentId));
            } catch (SQLException ex) {
                Logger.getLogger(PostController.class.getName()).log(Level.SEVERE, null, ex);
            }
            url = "/home.jsp";
        ...
        else if(action.equalsIgnoreCase("viewPostsCategory")){
            String category = request.getParameter("searchCategory");
            System.out.println(category);
            ArrayList<Post> posts = null;
            try {
                posts = PostDB.getPostsWithCategory(category);
            } catch (SQLException ex) {
                Logger.getLogger(PostController.class.getName()).log(Level.SEVERE, null, ex);
            }
            request.setAttribute("posts", posts);
            url = "/viewpostwithcategory.jsp";
